    ...
    callbacks.resolveCallback({
        content: {
            ...
            toImage: function () {
                return new Promise(function (resolveImage, rejectImage) {
                    if (result.responseAsImage != null) {
                        resolveImage(image_source_1.fromNativeSource(result.responseAsImage));
                    }
                    else {
            ...
            toFile: function (destinationFilePath) {
                ...
                var stream;
                try {
                    var file = file_system_1.File.fromPath(destinationFilePath);
...
function buildJavaOptions(options) {
    ...
    javaOptions.screenWidth = platform_1.screen.mainScreen.widthPixels;
    javaOptions.screenHeight = platform_1.screen.mainScreen.heightPixels;
    return javaOptions;
}

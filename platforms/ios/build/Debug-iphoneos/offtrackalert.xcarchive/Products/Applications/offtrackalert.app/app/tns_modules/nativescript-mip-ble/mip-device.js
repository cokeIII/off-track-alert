...
const mip_controller_1 = require("./mip-controller");
const mip_status_reader_1 = require("./mip-status-reader");
class MipDevice {
        ...
        return new Promise((resolve, reject) => {
            bluetooth.connect({
                ...
                onConnected: ((peripheral) => {
                    ...
                    this.mipController = new mip_controller_1.MipController(this.UUID);
                    this.mipStatusReader = new mip_status_reader_1.MipStatusReader(this.UUID);
                    resolve(this.UUID);
                }),
    ...
    convertTurnSpeed(turnSpeed, crazySpeed) {
        if (turnSpeed === 0)
            return 0x40;
        if (crazySpeed) {
            if (turnSpeed > 1)

...
var ImageFilters = (function () {
    ...
    ImageFilters.prototype._getBitmap = function (img) {
        var bm = net.bradmartin.flexing.ImagesKt.getBitmapFromImageView(img.android);
        return bm;
    };
    ...
    ImageFilters.prototype.rotate = function (img, degree) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                ...
                var bmp = _this._processor.rotate(_this._getBitmap(img), degree);
                var isrc = image_source_1.fromNativeSource(bmp);
                resolve(isrc);
            }
            catch (err) {
    ...
    ImageFilters.prototype.brightness = function (img, value) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                ...
                var bmp = _this._processor.doBrightness(_this._getBitmap(img), value);
                var isrc = image_source_1.fromNativeSource(bmp);
                resolve(isrc);
            }
            catch (err) {

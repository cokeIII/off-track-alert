...
const mip_device_1 = require("./mip-device");
    ...
    scan(deviceFound) {
        return bluetooth.startScanning({
            ...
            onDiscovered: peripheral => {
                ...
                var newDevice = new mip_device_1.MipDevice(peripheral.UUID, peripheral.name, peripheral.state);
                deviceFound(newDevice);
            }
        });
    }
    checkIfWowWeeMiP(periperhal) {
